...
POSTGIS_TRIGGER_SQL_2 = "DROP TRIGGER IF EXISTS trg_enforce_resolution ON tickets;"

POSTGIS_TRIGGER_SQL_3 = """
...
async def init_database():
    ...
    async with engine.begin() as conn:
        ...
        await conn.execute(text(POSTGIS_TRIGGER_SQL_1))
        await conn.execute(text(POSTGIS_TRIGGER_SQL_2))
        await conn.execute(text(POSTGIS_TRIGGER_SQL_3))
