...
class User(Base):
    ...
    role: Mapped[str] = mapped_column(String(20), nullable=False, default="citizen")  # citizen, officer, admin
    dept_code: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)  # ROADS, SWD, etc.
